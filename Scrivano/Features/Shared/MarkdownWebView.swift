...
struct MarkdownWebView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        wv.isOpaque = false
        let bg = UIColor(red: 0.024, green: 0.055, blue: 0.118, alpha: 1)
    ...
    private func buildHTML(_ md: String) -> String {
        // Escape markdown for safe embedding as a JS double-quoted string literal
        let jsonStr = md
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        blockquote {
            ...
            margin:0.7em 0; padding:7px 14px;
